...
i64 ComputeAddress(struct Machine *, u64);
struct AddrSeg LoadEffectiveAddress(const struct Machine *, u64);
u8 *ComputeReserveAddressRead(struct Machine *, u64, size_t);
u8 *ComputeReserveAddressRead1(struct Machine *, u64);
u8 *ComputeReserveAddressRead4(struct Machine *, u64);
u8 *ComputeReserveAddressRead8(struct Machine *, u64);
u8 *ComputeReserveAddressWrite(struct Machine *, u64, size_t);
u8 *ComputeReserveAddressWrite1(struct Machine *, u64);
u8 *ComputeReserveAddressWrite4(struct Machine *, u64);
u8 *ComputeReserveAddressWrite8(struct Machine *, u64);
u8 *GetModrmRegisterBytePointerRead(struct Machine *, u64);
u8 *GetModrmRegisterBytePointerWrite(struct Machine *, u64);
u8 *GetModrmRegisterMmPointerRead(struct Machine *, u64, size_t);
u8 *GetModrmRegisterMmPointerRead8(struct Machine *, u64);
u8 *GetModrmRegisterMmPointerWrite(struct Machine *, u64, size_t);
u8 *GetModrmRegisterMmPointerWrite8(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerRead(struct Machine *, u64, size_t);
u8 *GetModrmRegisterWordPointerRead2(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerRead4(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerRead8(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerReadOsz(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerReadOszRexw(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerWrite(struct Machine *, u64, size_t);
u8 *GetModrmRegisterWordPointerWrite2(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerWrite4(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerWrite8(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerWriteOsz(struct Machine *, u64);
u8 *GetModrmRegisterWordPointerWriteOszRexw(struct Machine *, u64);
u8 *GetModrmRegisterXmmPointerRead(struct Machine *, u64, size_t);
u8 *GetModrmRegisterXmmPointerRead16(struct Machine *, u64);
u8 *GetModrmRegisterXmmPointerRead4(struct Machine *, u64);
u8 *GetModrmRegisterXmmPointerRead8(struct Machine *, u64);
u8 *GetModrmRegisterXmmPointerWrite(struct Machine *, u64, size_t);
u8 *GetModrmRegisterXmmPointerWrite16(struct Machine *, u64);
u8 *GetModrmRegisterXmmPointerWrite4(struct Machine *, u64);
u8 *GetModrmRegisterXmmPointerWrite8(struct Machine *, u64);
